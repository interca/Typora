...
![zookeeper-1](https://gitee.com/hongshenghyj/typora/raw/master/img/zookeeper-1.png)
...
1. **维护配置信息**
   ...
   - `java`编程经常会遇到配置项，比如数据库的`url`、 `schema`、`user`和 `password`等。通常这些配置项我们会放置在配置文件中，再将配置文件放置在服务器上当需要更改配置项时，需要去服务器上修改对应的配置文件。
     ...
     **`zookeeper`就可以提供这样一种服务**，其使用`Zab`这种一致性协议来保证一致性。现在有很多开源项目使用`zookeeper`来维护配置，如在 `hbase`中，客户端就是连接一个 `zookeeper`，获得必要的 `hbase`集群的配置信息，然后才可以进一步操作。还有在开源的消息队列 `kafka`中，也便用`zookeeper`来维护 `brokers`的信息。在 `alibaba`开源的`soa`框架`dubbo`中也广泛的使用`zookeeper`管理一些配置来实现服务治理。
     ...
     ![zookeeper-2](https://gitee.com/hongshenghyj/typora/raw/master/img/zookeeper-2.png)
...
3. 集群管理
   ...
   - 一个集群有时会因为各种软硬件故障或者网络故障，出现棊些服务器挂掉而被移除集群，而某些服务器加入到集群中的情况，`zookeeper`会将这些服务器加入/移出的情况通知给集群中的其他正常工作的服务器，以及时调整存储和计算等任务的分配和执行等。此外`zookeeper`还会对故障的服务器做出诊断并尝试修复。
     ...
     ![zookeeper-3](https://gitee.com/hongshenghyj/typora/raw/master/img/zookeeper-3.png)
...
![zookeeper-4](https://gitee.com/hongshenghyj/typora/raw/master/img/zookeeper-4.png)
...
![zookeeper-5](https://gitee.com/hongshenghyj/typora/raw/master/img/zookeeper-5.png)
...
![微信截图_20221115092614](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115092614.png)

   

![微信截图_20221115094214](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115094214.png)



  

![微信截图_20221115094231](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115094231.png)



![微信截图_20221115142847](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115142847.png)
...
![微信截图_20221115143155](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115143155.png)

  

单体：  

![微信截图_20221115143639](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115143639.png)
...
![微信截图_20221115144243](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115144243.png)
...
![微信截图_20221115145113](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115145113.png)
...
![微信截图_20221115145306](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115145306.png)
...
![微信截图_20221115150105](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115150105.png)
...
简单来说就是有一个注册中心  然后远程调用

![微信截图_20221115185425](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115185425.png)

  

注册中心一般用zookeeper

![微信截图_20221115195628](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115195628.png)
...
![微信截图_20221115212438](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221115212438.png)



配置文件 扫描包

这里不用spring扫描 因为不是加载到容器里面

![](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221127223627.png)



生产者

![微信截图_20221116205243](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20221116205243.png)
...
![微信截图_20221116205939](https://gitee.com/hongshenghyj/typora/raw/master/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20